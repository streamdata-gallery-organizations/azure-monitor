...
paths:
  ...
  : put:
      ...
      x-api-path-slug: subscriptionssubscriptionidresourcegroupsresourcegroupnameprovidersmicrosoftinsightsactivitylogalertsactivitylogalertname-put
      parameters:
      - in: body
    ...
    get:
      ...
      x-api-path-slug: subscriptionssubscriptionidresourcegroupsresourcegroupnameprovidersmicrosoftinsightsactivitylogalertsactivitylogalertname-get
      parameters:
      - in: query
        name: No Name
      responses:
    ...
    delete:
      ...
      x-api-path-slug: subscriptionssubscriptionidresourcegroupsresourcegroupnameprovidersmicrosoftinsightsactivitylogalertsactivitylogalertname-delete
      parameters:
      - in: query
        name: No Name
      responses:
    ...
    patch:
      ...
      x-api-path-slug: subscriptionssubscriptionidresourcegroupsresourcegroupnameprovidersmicrosoftinsightsactivitylogalertsactivitylogalertname-patch
      parameters:
      - in: body
  ...
  /subscriptions/{subscriptionId}/providers/microsoft.insights/activityLogAlerts:
    get:
      ...
      x-api-path-slug: subscriptionssubscriptionidprovidersmicrosoftinsightsactivitylogalerts-get
      parameters:
      - in: query
        name: No Name
      responses:
  ...
  /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/microsoft.insights/activityLogAlerts:
    get:
      ...
      x-api-path-slug: subscriptionssubscriptionidresourcegroupsresourcegroupnameprovidersmicrosoftinsightsactivitylogalerts-get
      parameters:
      - in: query
        name: No Name
      responses:
